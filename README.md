...
- [MRC GlobalPay](https://mrcglobalpay.com) - x402-compatible settlement protocol for AI agents with a machine-readable [manifest](https://mrcglobalpay.com/trading-bot-manifest.json) for automated $0.30 micro-swaps.
